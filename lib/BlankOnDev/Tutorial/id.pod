...
=item 14.
Perintah C<B<boidev bzr2git git-push-new>> - Perintah ini merupakan perintah yang digunakan untuk mendorong/upload yang sudah didownload namum belum dikonversi ke format repositori github, berdasarkan nama paket yang sudah terdaftar pada system program B<BlankOnDev>. Perintah ini sama seperti instruksi dari github setelah nama repositori baru ditambahkan.
...
=item 17.
Perintah C<B<boidev bzr2git re-gitpush>> - Perintah ini digunakan untuk memperbaiki kesalahan upload paket ke github yang tidak dilakukan convert format sebelumnya.
...
=head3 Install dan Konfigurasi I<rng-tools>
...
=head3 Metode Instalasi secara Manual
...
=head4 Install Dependensi Module
...
=head3 Metode Instalasi BlankOnDev dari CPAN Perl
...
Dengan instalasi menggunakan perintah C<cpan -i>, maka versi yang terinstall dari module dependensi atau module B<BlankOnDev> yaitu versi terbaru, tidak seperti B<Metode instalasi manual>, dimana versi module tergantung versi yang Anda download.
...
<figcaption>Gambar 2.1. <b>Form Awal CPAN</b></figcaption>
</figure>
</center></p>
...
<figcaption>Gambar 2.2. <b>Instalasi Module Perl di Mulai</b></figcaption>
</figure>
</center></p>
...
<figcaption>Gambar 2.3. <b>Instalasi Module Selesai</b></figcaption>
</figure>
</center></p>
...
=item * Jika inputnya B<C<y>> maka akan tampil form config github seperti berikut :
...
Form berikut yaitu form B<Github config> clear cache atau aktifkan cache username dan passowrd github:
...
Setelah form disini, maka akan tampilk hasil B<Generate Key GnuPG> :
...
<figcaption>Gambar 2.4. <b>Daftar Paket yang telah ditambahkan dengan nama group github-6</b></figcaption>
</figure>
</center></p>
...
Proses yang dilakukan disini yaitu penggunaan perintah-perintah seperti contoh berikut, dengan perintah B<boidev> yang lebih aman untuk meminimalisir kesalahan penulisan perintah ataupun kesalahan penulisan I<nama paket>.
...
Seperti yang telah dijelaskan pada upabab \textit{\ref{subsec:implm}. Implementasi, di halaman \pageref{itm:metode_split}}, Bahwa I<metode> ini melakukukan I<branch paket>, I<convert format ke git>, dan I<push ke git> secara terpisah. Seperti metode migrasi yang dilakukan secara manual seperti yang ditunjukkan pada \textit{listing - \ref{lst:migrasi_manual} Perintah Migrasi} diatas. Berikut langkah-langkahnya :
...
\subsubsection{Perintah {\small C<boidev bzr2git bzr-cgit>}}
\noindent
Perintah yang dapat digunakan yaitu :

=over

=item * {\small C<boidev bzr2git bzr-cgit>}
=item * {\small C<boidev bzr2git bzr-cgit <nama\_group\_paket>>}
...
\subsubsection{Perintah {\small C<boidev bzr2git git-push>}}
\noindent
Perintah yang dapat digunakan yaitu :

=over

=item * {\small C<boidev bzr2git git-push>}

=item * {\small C<boidev bzr2git git-push <nama\_group\_paket>>}
...
Jika username dan password github di cache sebelumnya, maka proses berikutnya tidak akan lagi meminta untuk memasukkan I<username dan password>.
...
=head4 2.4.1.2. Perintah C<boidev bzr2git git-check>

Perintah yang dapat digunakan yaitu :

=over

=item * {\small C<boidev bzr2git git-check>}

=item * {\small C<boidev bzr2git git-check <nama\_group\_paket>>}
...
Jika anda ingin melihat hasil migrasi gunakan perintah\\ {\small C<boidev bzr2git list-pkg <nama\_group\_paket>>} seperti berikut :
...
<figcaption>Gambar 2.6. <b>List Packages</b></figcaption>
</figure>
</center></p>
...
<figcaption>Gambar 2.7. <b>List Packages bagian hasil git-check</b></figcaption>
</figure>
</center></p>
...
Seperti yang telah dijelaskan pada upabab L<I<2. Implementasi - Proses Migrasi Paket - Skema one-time>|file:///home/achmad/apps/BlankOnDev/lib/BlankOnDev/Tutorial/id.html#Proses-Migrasi-Paket>,
